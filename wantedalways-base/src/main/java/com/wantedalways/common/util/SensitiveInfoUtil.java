...
import com.wantedalways.common.annotation.SensitiveField;
import com.wantedalways.common.enums.SensitiveEnum;
import com.wantedalways.common.util.encryption.AesEncryptUtil;
...
public class SensitiveInfoUtil {
    ...
    public static String getDecodeData(String data){
        ...
        if(ObjectUtils.isEmpty(result) && ObjectUtils.isNotEmpty(data)){
            result = data;
        }
        return result;
    }
    ...
    private static String chineseName(String familyName, String firstName) {
        if (ObjectUtils.isEmpty(familyName) || ObjectUtils.isEmpty(firstName)) {
            return "";
        }
